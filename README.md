...
- 🏹 **[Mergen](https://github.com/TiaMEOWS/mergen)** — AI-powered offensive security harness. Agentic TUI with 40+ attack disciplines, a 7.7K-file knowledge base (MITRE ATT&CK, OWASP WSTG, CIS), and **MCP Guard**: audits its own MCP servers for tool poisoning before loading them. `TypeScript · AGPL-3.0`
- 🛡️ **[mcp-sentinel](https://github.com/TiaMEOWS/mcp-sentinel)** — zero-dependency security scanner for MCP servers: tool poisoning, rug pulls, auth bypass, schema hygiene. 20 checks, JSON output, CI-friendly. `Python · MIT`
